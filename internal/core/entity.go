...
// ServerStatistic - статистика по сокращенным URL и количеству пользователей в сервисе
type ServerStatistic struct {
	UrlQty int `json:"urls"`  // Количество сокращённых URL в сервисе
	UsrQty int `json:"users"` // Количество пользователей в сервисе
}
